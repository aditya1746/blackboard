...
def draw (event,x,y,flags, param):
    ...
    global drawing,color,mode,erase
    global prev_point
    ...
    if event == cv2.EVENT_LBUTTONDOWN and (y>45 and y<467) and mode=="pen":
    ...
    elif event == cv2.EVENT_LBUTTONDOWN and (y>45 and y<467) and mode=="erase":
    ...
    elif event == cv2.EVENT_MOUSEMOVE and erase == True and (y>45 and y<467) and mode=="erase":

        #cv2.circle(img,(x,y),5,(0,0,0),-1)

        cv2.line(img,prev_point,(x,y),(0,0,0),10)
        ...
        if y>=467 and y<=512:
            ...
            if x>=10 and x<=40 and y>=477 and y<=507:
                ...
                cv2.circle(img,(25,492),15,white,3)
                ...
                cv2.circle(img,(200,492),15,yellow,-1)
                cv2.circle(img,(235,492),15,skyblue,-1)
                cv2.circle(img,(270,492),15,pink,-1)

            if x>=45 and x<=75 and y>=477 and y<=507:
                color = white
                cv2.circle(img,(25,492),15,black,-1)
                cv2.circle(img,(60,492),15,white,-1)
                cv2.circle(img,(60,492),15,black,3)
                cv2.circle(img,(95,492),15,red,-1)
                cv2.circle(img,(130,492),15,green,-1)
                cv2.circle(img,(165,492),15,blue,-1)
                cv2.circle(img,(200,492),15,yellow,-1)
            ...
            if x>=80 and x<=110 and y>=477 and y<=507:
                ...
                cv2.circle(img,(60,492),15,white,-1)
                cv2.circle(img,(95,492),15,red,-1)
                cv2.circle(img,(95,492),15,black,3)
                cv2.circle(img,(130,492),15,green,-1)
                cv2.circle(img,(165,492),15,blue,-1)
                cv2.circle(img,(200,492),15,yellow,-1)
                cv2.circle(img,(235,492),15,skyblue,-1)
...
cv2.circle(img,(95,492),15,red,-1)
cv2.circle(img,(130,492),15,green,-1)
cv2.circle(img,(130,492),15,black,3)
cv2.circle(img,(165,492),15,blue,-1)
cv2.circle(img,(200,492),15,yellow,-1)
cv2.circle(img,(235,492),15,skyblue,-1)
cv2.circle(img,(270,492),15,pink,-1)
